                        ...
                        <div class="container-fluid">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    ...
                                    <p class="text-white-50 mb-0">Live rankings and team performance</p>
                                </div>
                                <div class="col-md-4 text-end">
                                    <div class="d-flex justify-content-end gap-3">
                                        <div class="text-center">
                                            <div class="text-white fw-bold fs-5"><?= date('M d') ?></div>
                                            <div class="text-white-50 small">Updated</div>
                                        </div>
                            ...
                            <table class="table table-hover mb-0" style="border-collapse: separate; border-spacing: 0;">
                                <thead>
                                    <tr style="background: #f8f9fa;">
                                        ...
                                        <th class="border-0 py-4 fw-bold" style="color: #0000ff; min-width: 250px;">
                                            <i class="fas fa-shield-alt me-1"></i>TEAM
                                        </th>
                                        <th class="border-0 py-4 text-center fw-bold" style="color: #0000ff; width: 100px;">
                                        ...
                                        <th class="border-0 py-4 text-center fw-bold" style="color: #0000ff; width: 120px;">
                                                        ...
                                                        <?php if (!empty($team['logo_url'])): ?>
                                                            <?php 
                                                                ...
                                                                if (strpos($logoPath, 'uploads/logos/') === 0) {
                                                                    // Path already includes uploads/logos/
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-8">
                        <div class="card border-0 shadow-sm h-100" 
                             style="border-radius: 20px; background: linear-gradient(135deg, rgba(0, 0, 255, 0.02), white);">
                            <div class="card-header border-0" 
                                 style="background: linear-gradient(135deg, #0000ff, #0033cc); border-radius: 20px 20px 0 0;">
                                <h5 class="text-white fw-bold mb-0 py-2">
                            ...
                            <div class="card-body p-4">
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        <div class="scoring-rule p-3 h-100" 
                                             style="border-radius: 16px; background: rgba(40, 167, 69, 0.08); 
                                                    border: 1px solid rgba(40, 167, 69, 0.2); text-align: center;">
                                            <div class="icon-wrapper mb-3" 
                                                 style="width: 50px; height: 50px; margin: 0 auto; border-radius: 50%; 
                                                        background: linear-gradient(135deg, #28a745, #20c997); 
                                                        display: flex; align-items: center; justify-content: center;">
                                                <i class="fas fa-trophy text-white fa-lg"></i>
                                            </div>
                                            <h6 class="fw-bold mb-2" style="color: #28a745;">Victory</h6>
                                            <div class="fw-bold" style="color: #0000ff; font-size: 1.5rem;">2</div>
                                            <small class="text-muted">Points</small>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="scoring-rule p-3 h-100" 
                                             style="border-radius: 16px; background: rgba(255, 193, 7, 0.08); 
                                                    border: 1px solid rgba(255, 193, 7, 0.2); text-align: center;">
                                            <div class="icon-wrapper mb-3" 
                                                 style="width: 50px; height: 50px; margin: 0 auto; border-radius: 50%; 
                                                        background: linear-gradient(135deg, #ffc107, #ffed4e); 
                                                        display: flex; align-items: center; justify-content: center;">
                                                <i class="fas fa-handshake text-dark fa-lg"></i>
                                            </div>
                                            <h6 class="fw-bold mb-2" style="color: #ffc107;">Defeat</h6>
                                            <div class="fw-bold" style="color: #0000ff; font-size: 1.5rem;">1</div>
                                            <small class="text-muted">Point</small>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="scoring-rule p-3 h-100" 
                                             style="border-radius: 16px; background: rgba(220, 53, 69, 0.08); 
                                                    border: 1px solid rgba(220, 53, 69, 0.2); text-align: center;">
                                            <div class="icon-wrapper mb-3" 
                                                 style="width: 50px; height: 50px; margin: 0 auto; border-radius: 50%; 
                                                        background: linear-gradient(135deg, #dc3545, #c82333); 
                                                        display: flex; align-items: center; justify-content: center;">
                                            ...
                                            <h6 class="fw-bold mb-2" style="color: #dc3545;">Forfeit</h6>
                                            <div class="fw-bold" style="color: #dc3545; font-size: 1.5rem;">-1</div>
                                            <small class="text-muted">Point</small>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-body p-4 text-white">
                                ...
                                <div class="stat-item mb-4">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <span class="text-white-50">Total Teams</span>
                                        <span class="fw-bold fs-4"><?= count($standings) ?></span>
                                    </div>
                                </div>
                                
                                <div class="stat-item mb-4">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <span class="text-white-50">Matches Played</span>
                                        <span class="fw-bold fs-4"><?= array_sum(array_column($standings, 'played')) / 2 ?></span>
                                    </div>
                                </div>
                                
                                <div class="stat-item mb-4">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <span class="text-white-50">Leader Points</span>
                                        <span class="fw-bold fs-4"><?= $standings[0]['points'] ?? 0 ?></span>
                                    </div>
                                </div>
...
<style>
    ...
    .team-avatar, .team-logo-container {
        transition: all 0.3s ease;
    }
